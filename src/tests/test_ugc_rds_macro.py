...
def test_handler_remove_property(monkeypatch):
    ...
    monkeypatch.setenv("property_to_remove","BackupRetentionPeriod")
    monkeypatch.setenv("property_to_add","")
...
def test_handler_add_property(monkeypatch):
    monkeypatch.setenv("property_to_remove","")
    monkeypatch.setenv("latest_snapshot","False")
    monkeypatch.setenv("property_to_add",'{"BackupRetentionPeriod": {"Ref": "BackupRetentionDays"}}')
    monkeypatch.setenv("db_instance","")
